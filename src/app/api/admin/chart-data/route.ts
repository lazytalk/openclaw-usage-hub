...
const METRIC_SQL: Record<ChartMetric, string> = {
  ...
  input_cost_usd: "COALESCE(SUM(input_cost_usd), 0)::double precision",
  output_cost_usd: "COALESCE(SUM(output_cost_usd), 0)::double precision",
  cache_cost_usd: "COALESCE(SUM(cache_cost_usd), 0)::double precision",
  duration_ms: "COALESCE(SUM(duration_ms), 0)::double precision",
  time_to_first_token_ms: "COALESCE(SUM(time_to_first_token_ms), 0)::double precision",
  retry_count: "COALESCE(SUM(retry_count), 0)::double precision",
